        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="{{ url('gambar/profil', [Auth::user()->gambar]) }}" width="80%" class="rounded-circle" alt="">
                </div>
                        ...
                        <div
                            ...
                            <form action="{{ route('ubah.nama', []) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="alamat" class="form-control" type="text" value="{{ empty(Auth::user()->identitas->alamat)?'':Auth::user()->identitas->alamat }}" name="alamat">
                                </div>
                                <div class="form-group">
                                    <label for="nohp">Nomor HP/WA</label>
                                    <input id="nohp" class="form-control" type="number" value="{{ empty(Auth::user()->identitas->nohp)?'':Auth::user()->identitas->nohp }}" name="nohp">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input id="email" class="form-control" type="email" value="{{ empty(Auth::user()->identitas->email)?'':Auth::user()->identitas->email }}" name="email">
                                </div>
